...
loadscript('https://cdnjs.cloudflare.com/ajax/libs/lodash.js/3.2.0/lodash.js', script => {
    alert('Great, script ${script.scr} has been loaded');
...
loadscript('script.js', function(script) {
    alert('Great, script ${script.scr} has been loaded, lets load one more);

    loadscript('script2.js', function(script) {
        alert('Great, second script has been loaded');
    });
});
```
...
function loadscript(scr, callback) {
    ...
    script.onerror = () => callback(new Error('Fail to load script ${scr}));
