...
Иногда вместо `event.stopPropagation()` и останавливания "всплытие" мы можем использовать `event.defaultPrevented`, чтобы просигналить другим обработчикам, что событие обработано.
